...
public class ProfessorGrade {
	...
	public ProfessorGrade(String subjectTerm, String memberLevel, String memberName, String memberId,
	...
	public String toString() {
		return "ProfessorGrade [subjectTerm=" + subjectTerm + ", memberLevel=" + memberLevel + ", memberName="
