...
public class Enrol {
	...
	public Enrol(String subjectTerm, String subjectLebel, String departmentName, String subjectNo, String subjectName,
			String memberName, String subjectTime, String subjectClassroom, String subjectCredit) {
		super();
	...
	public String toString() {
		return "Enrol [subjectTerm=" + subjectTerm + ", subjectLebel=" + subjectLebel + ", departmentName="
