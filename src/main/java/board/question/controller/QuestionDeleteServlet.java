 ...
 */
@WebServlet("/board/questionDelete")
public class QuestionDeleteServlet extends HttpServlet {
	...
	try {
		...
		// 업무로직
		// 첨부파일 존재시 삭제
		List<BoardAttachment> attachments = questionService.findByNo(no).getBoardAttachments();
		...
		int result = questionService.deleteBoard(no);
