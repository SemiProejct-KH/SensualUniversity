...
public class PresentlyStudentClass {
	...
	public PresentlyStudentClass() {
		super();
		// TODO Auto-generated constructor stub
	}
	public PresentlyStudentClass(String subjectTerm, String subjectLebel, String departmentName, String subjectNo,
	...
	public String toString() {
		return "PresentlyStudentClass [subjectTerm=" + subjectTerm + ", subjectLebel=" + subjectLebel
				+ ", departmentName=" + departmentName + ", subjectNo=" + subjectNo + ", subjectName=" + subjectName
				+ ", memberName=" + memberName + ", subjectTime=" + subjectTime + ", subjectClassroom="
				+ subjectClassroom + ", subjectCredit=" + subjectCredit + "]";
	}
